...
const temp_upload = require("../middleware/temp_upload");
...
router.post('/attend', fetchuser, upload.single("file"),async (req,res)=>{
...
const newve = router.post("/newupload", upload.single("file"), fetchuser,async (req, res) => {
    ...
    return res.status(200).json({message:"success",url:imgUrl})
});
