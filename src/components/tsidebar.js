...
export const Tsidebar = () => {
  ...
  return (
   ...
   {/* <button className="colbtn" onClick={event => handleClick(event,`${parseInt(number)}` )}>col</button> */}
      <div id="sideid" className="kaguya relly max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent translate-x-0 shadow-soft-xl bckol ps2" style={{position:"relative"}}>
          ...
          >
            ...
            <div className="relative z-20 flex-auto w-full p-4 text-left text-white ps2" style={{overflow:"auto",maxHeight:"200px"}}>
              <div className="d-flex">
                ...
                <img className="vec2" src={vec2} alt="" /></div>
                <div className="contentdata">
                  <div className="onee onec">Shaktimaan</div>
                  <div className="tonee onec">F-312</div>
                </div>
              </div>
